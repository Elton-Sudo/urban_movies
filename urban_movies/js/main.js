...
function popularMovies() {
    axios.get('https://api.themoviedb.org/3/movie/popular?api_key=86725f05154964eebf27b4d695abe22e&language=en-US&page=1')
        .then((response) => {
...
function getMovies(searchText) {
    ...
    axios.get('https://api.themoviedb.org/3/search/movie?api_key=86725f05154964eebf27b4d695abe22e&query=' + searchText)
...
function getReviews() {
    ...
    axios.get(`https://api.themoviedb.org/3/movie/${movieId}/reviews?api_key=86725f05154964eebf27b4d695abe22e&language=en-US&page=1`)
...
function getMovie() {
    ...
    axios.get(`https://api.themoviedb.org/3/movie/${movieId}?api_key=86725f05154964eebf27b4d695abe22e`)
        .then((response) => {
...
function getTopMovies() {
    axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=86725f05154964eebf27b4d695abe22e&language=en-US&page=1')
        .then((response) => {
            console.log(response);
