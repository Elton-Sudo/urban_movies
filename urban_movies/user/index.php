...
<head>
    ...
    <title>Welcome to Urban Movies</title>
...
<body>
    <nav class="navbar navbar-expand-sm bg-secondary navbar-dark fixed-top ">
        ...
        <ul class="navbar-nav ">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="request.php">Watchlist Request</a>
            </li>
            ...
            <center>
                <div class=" inner-body ">
                    ...
                    <p style="color: white" class="content">
                        Welcome to
                        <span style="font-weight:bold; color: #6AC045">Urban Movies</span>
                    </p>
                </div>
                <div class="container">
    ...
    <div class="about-box ">
        <center>
            <div class="about ">
                ...
                <p class="about-content ">A basic movie website using the TMDB API.</p>
            </div>
        </center>
    </div>
